...
def start_training(character:Character):
    ...
    print('Введи одну из трех команд: attack - чтобы атаковать противника, '
    'defence - чтобы блокировать атаку противника или '
    'special - чтобы использовать совю суперсилу.')
    print('Если не хочешь тренироваться - введи команду skip.')

    command = ''
    action_dictionary = { 'attack':  character.attack(),
    ...
    while command != 'skip':
        ...
        if command in action_dictionary.keys():
            print(action_dictionary[command])
        return('Конец тренировки.')
...
def main() -> None:
    ...
    print('Ты можешь выбрать один из трех путаей силы: ')
